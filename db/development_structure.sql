...
CREATE TABLE "profiles" ("id" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, "login" varchar(255), "nk_id" varchar(255), "url" varchar(255), "email" varchar(255), "html" text, "tos" boolean, "status" integer, "created_at" datetime, "updated_at" datetime);
